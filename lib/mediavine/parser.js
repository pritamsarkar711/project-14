...
const AD_NETWORKS = [
  ...
  ['Mediavine', /mediavine\.com|mediavine\.cloudfront|grow\.hsvr|grow\.mediavine/i],
...
function parsePage(result) {
  ...
  const adScripts = uniqueScripts.filter(s => /pagead|googlesyndication|doubleclick|adsystem|adservice|media\.net|ezoic|monumetric|raptive|adthrive|mediavine|grow\.mediavine|buysellads|propellerads|taboola|outbrain|mgid|revcontent|playwire|newormedia/i.test(s)).length;
